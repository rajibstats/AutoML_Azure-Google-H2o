...
def RunAutoML():
        ...
        try:
            ...
            automl_config = AutoMLConfig(task=tasks,
                                         ...
                                         path='D:\\Stock_Prediction\\AutoML_Azure\\python\\Flask_API_Azure\\log',
            ...
            model = best_run.register_model(model_name=best_model+str(date.today()), model_path='outputs/model.pkl')
            ...
            rundata.rename(column = {0: "one", 1: "two",2: "three",3: "four",4: "five",5: "six",6: "seven",
